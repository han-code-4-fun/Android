...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent openWaterReminderIntentService =
                new Intent(this, WaterReminderIntentService.class);
        //  (16) Set the action of the intent to ACTION_INCREMENT_WATER_COUNT
        openWaterReminderIntentService.setAction(ReminderTasks.ACTION_INCREMENT_WATER_COUNT);

        //  (17) Call startService and pass the explicit intent you just created
        startService(openWaterReminderIntentService);
