...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // hold the total number of ViewHolders that are created
    ...
    public NumberViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        viewHolder.holderIndex.setText("ViewHolder index: "+ viewHolderCount);

        // TODO (13) Use ColorUtils.getViewHolderBackgroundColorFromInstance and pass in a Context and the viewHolderCount
        int thisColor = ColorUtils.getViewHolderBackgroundColorFromInstance(context, viewHolderCount);
        // TODO (14) Set the background color of viewHolder.itemView with the color from above
        viewHolder.itemView.setBackgroundColor(thisColor);
        // TODO (15) Increment viewHolderCount and log its value
        viewHolderCount++;
        Log.i(TAG,"viewHolderCount incremented, current value: "+viewHolderCount);
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder {
        ...
        public NumberViewHolder(View itemView) {
            ...
            holderIndex = (TextView) itemView.findViewById(R.id.tv_view_holder_instance);
        }
