...
public class MainActivity extends AppCompatActivity
    ...
    private static final int MAINLOADER_ID = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //loadWeatherData();
        getSupportLoaderManager().initLoader(MAINLOADER_ID,null, MainActivity.this).forceLoad();
    }
   ...
   /* private void loadWeatherData() {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(MAINLOADER_ID, null, this);
            return true;
        }
