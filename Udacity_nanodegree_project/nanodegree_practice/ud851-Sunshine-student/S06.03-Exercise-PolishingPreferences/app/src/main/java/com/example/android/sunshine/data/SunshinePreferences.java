...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        String locaitonKey = context.getString(R.string.pref_location_key);
        String defaultLocation =context.getString(R.string.pref_location_default);
        return sharedPreferences.getString(locaitonKey, defaultLocation);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        SharedPreferences sharedPreferences =
                PreferenceManager.getDefaultSharedPreferences(context);
        String userSelectUnit = context.getString(R.string.pref_units_key);
        String defaultVal  = context.getString(R.string.pref_units_metric);
        String unit =  sharedPreferences.getString(userSelectUnit,defaultVal);

        return unit == context.getString(R.string.pref_units_metric);
    }
