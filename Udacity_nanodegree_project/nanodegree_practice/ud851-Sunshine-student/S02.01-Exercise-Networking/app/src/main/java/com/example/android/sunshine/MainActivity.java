...
public class MainActivity extends AppCompatActivity {
    ...
    {
        String input = SunshinePreferences.getPreferredWeatherLocation(this);
        new AsynWeather().execute(input);
    }
    // TODO (8) Create a method that will get the user's preferred location and execute your new AsyncTask and call it loadWeatherData

    // TODO (5) Create a class that extends AsyncTask to perform network requests

    public class AsynWeather extends AsyncTask<String, Void, String>{

        @Override
        protected String doInBackground(String... urls) {
            String temp = urls[0];
            URL url = NetworkUtils.buildUrl(temp);
            ...
            {
                Log.e("mainClass","error parsing URL to JSON");
            }
